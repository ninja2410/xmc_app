      ...
      <div class="content">
          ...
          <div class="card col-md-12">
            <div class="card-header card-header-danger">
              <h3 class="card-title">Modificar documentos</h3>
            ...
            <div class="card-body">
              <form method="post", action="..\entrenador\store_document.php" enctype="multipart/form-data" id="frm_document">
                ...
                <input type="hidden" name="id_entrenador" value="<?php echo $data['id_entrenador']; ?>">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <img src="..\imagenes\doc_ent\<?php echo $data['path']; ?>" style="width: 200px; height: 150px;" alt="">
                    <br>
