<?php
/**
 *Clase enviar correo a entrenadores
 */
class Correo
{
  public function enviarCorreo($lesion, $correo){
    $destinatario = $correo;
    $asunto = "Reporte de lesion";
    $cuerpo = '
    <!doctype html>
    <html>
    <head>
    <title>Lesion de Jugador</title>
    <meta charset="utf-8">
    </head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
    <center><h2 style="color: #153643; font-family: Arial, sans-serif; font-size: 24px; text-align: center;">Reporte lesion de Jugador:</h2></center>

    </tr>
    <tr>
    <tr>
    <td style="padding: 20px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 10px;">
        <p style="font-weight: bold;">Nombre de Jugador:</p>
        <p> '.$lesion['JUGADOR'] .'</p>
    ...
    <tr>
      ...
      <td style="padding: 10px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 10px;">
        ...
        <p>'.$lesion['observacion'].'</p>
      </td>
    </tr>
    <tr>
      <td style="padding: 10px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 10px;">
        <p style="font-weight: bold;">Tipo de lesion:</p>
        <p>'.$lesion['lesion']'.</p>
      </td>
    ...
    <p style="font-weight: bold;">Fecha de pago:</p>
        <p>Fecha de lesion: '.$lesion['fecha_inicio'].'</p>
    ...
    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 18px; text-align: center;" width="75%" >
            <strong>Sistema Gestión de Lesiones <br /> <br /></strong><br />
    ...
    $headers .= "From: Club Xelaju MC <admin@xelaju.club>\r\n";

    //dirección de respuesta, si queremos que sea distinta que la del remitente
    $headers .= "Reply-To: admin@xelaju.club\r\n";

    //ruta del mensaje desde origen a destino
    $headers .= "Return-path: pagos@xelaju.club\r\n";
